...
export interface EasyButtonProps extends useRender.ComponentProps<"button"> {
  variant?: VariantProps<typeof easyButtonVariants>["variant"];
...
export const EasyButton = React.forwardRef<HTMLButtonElement, EasyButtonProps>(
  function EasyButton(
    ...
    const defaultProps = {
      ...
      className: cn(easyButtonVariants({ className, size, variant })),
      "aria-disabled": loading || undefined,
      "data-loading": loading ? "" : undefined,
      "data-slot": "easy-button",
      disabled: isDisabled,
      ref,
      type: typeValue,
    };
